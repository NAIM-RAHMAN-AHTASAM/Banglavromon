...
require 'db.php';
 ...
 <?php
$select="SELECT * FROM tb_registration WHERE status=1 ORDER by id DESC";
      ...
      <div class="col-lg-12">
        ...
        <table class="table table-dark table-striped">
          ...
          <tr>
            ...
            <td>
              <a href="single_view.php?id=<?php echo $users_info['id'];?>" class="btn btn-info">View</a>
              ...
              $select2="SELECT * FROM tb_registration  ORDER by id DESC";
              ...
              <?php if ($_SESSION['role']==1 || $_SESSION['role']==2 || $_SESSION['role']==3) { ?>
              <a href="undo.php?id=<?php echo $users_info['id'];?>" class="btn btn-success">Undo</a>
              <?php } ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a href="delete_user.php?id=<?php echo $users_info['id'];?> " class="btn btn-primary">Yes</a>
                </div>
              </div>
            </div>
          </div>
