...
<section>
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 text-center m-auto py-3 bg-dark">
        ...
        <div class="form-group text-white">
          ...
          value="<?php echo $after_assoc['banner_title']?>">
        </div>

        <div class="form-group text-white">

          <input type="text" class="form-control" name="banner_description"
          value="<?php echo $after_assoc['banner_description']?>">
        ...
        <div class="form-group text-white">
          ...
          value="<?php echo $after_assoc['banner_btn']?>">
    ...
    <div class="">
      <img src="uploads/banners/<?php echo $after_assoc['banner_img']?>" alt="" id="imgs"width="100">
    </div>
